# Functional Python [![](https://github.com/ypei23/functional-python/workflows/tests/badge.svg)](https://github.com/ypei23/functional-python/actions?query=workflow%3Atests)
